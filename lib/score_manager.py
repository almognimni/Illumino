...
class ScoreManager:
    def __init__(self, usersettings):
        ...
        if usersettings.get_setting_value("score_base_score"):
            self.base_score = int(usersettings.get_setting_value("score_base_score"))
        else:
            usersettings.change_setting_value("score_base_score", self.base_score)
            
        if usersettings.get_setting_value("score_max_delay"):
            self.max_delay = float(usersettings.get_setting_value("score_max_delay"))
        else:
            usersettings.change_setting_value("score_max_delay", self.max_delay)
            
        if usersettings.get_setting_value("score_penalty"):
            self.penalty = int(usersettings.get_setting_value("score_penalty"))
        else:
            usersettings.change_setting_value("score_penalty", self.penalty)
